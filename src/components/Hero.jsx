...
const Hero = () => {
  ...
  return (
    <div className="mt-22 flex flex-col items-center justify-center w-full h-[80vh] bg-feastlavender border-b-10 border-t-10 border-feastpurple rounded-2xl  sm:flex-row sm:justify-between shadow-lg mb-1 sm:p-2">
